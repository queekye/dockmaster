...
class SchedulerDaemon:
    ...
    def _update_status(self, status: str = None, task_info: Dict[str, Any] = None) -> None:
        """
        更新调度器状态文件
    ...
    def _run_task_with_logging(self, task_type: str, task_func: Callable) -> None:
        """
        执行任务并记录日志
    ...
    def get_logs(self, task_type: str = None, lines: int = 100) -> str:
        """
        获取日志内容
